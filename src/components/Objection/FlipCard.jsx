...
export default function FlipCard({
    ...
    return (
        ...
        >
            ...
            >
                {/* FRONT - Concern */}
                <div className="absolute w-full h-full backface-hidden rounded-2xl shadow-xl bg-blue-100 p-6 flex flex-col justify-between">
                    <div>
                        <h3 className="text-xl font-semibold mb-4 border-b-2 py-4 text-blue-700 ">
                            {title}
                        </h3>
                    ...
                    <button className="mt-4 border border-blue-700 px-4 py-4 text-md cursor-pointer font-semibold text-gray-50 bg-blue-700">
